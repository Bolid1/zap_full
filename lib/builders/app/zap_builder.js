  ...
  var getEntitiesHooks = function () {
    ...
    _.each(['contact', 'lead', 'company'], function (entity) {
      ...
      _.each(actions, function (action) {
        ...
        out.push({
          name: action_name,
          body: "return Application.convertEntity('" + action + "', '" + entity + "', bundle.request.content, bundle.auth_fields.account, bundle.auth_fields.top_level_domain);"
        });
        ...
        out.push({
          name: action_name,
          body: "return [Application.convertEntity('" + action + "', '" + entity + "', bundle.response.content, bundle.auth_fields.account, bundle.auth_fields.top_level_domain)];"
        });
      });
