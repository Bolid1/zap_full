...
Searches = JsonBase.extend({
  ...
  _template: {
    ...
    important: true,
    hide: false,
    url: 'https://{{account}}.amocrm.{{top_level_domain}}/private/api/v2/json/%s/list/',
    custom_fields_url: 'https://{{account}}.amocrm.{{top_level_domain}}/private/api/v2/json/accounts/current/',
    resource_url: 'https://{{account}}.amocrm.{{top_level_domain}}/private/api/v2/json/%s/list/?id={{id}}',
