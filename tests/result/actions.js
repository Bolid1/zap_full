  ...
  _.each(actions, function (props, key) {
    ...
    describe('action#' + key, function () {
      ...
      it('Url must be valid', function () {
        var valid_url = 'https://{{account}}.amocrm.{{top_level_domain}}/private/api/v2/json/%s/set/';
      ...
      it('Important check', function () {
        ...
        props.important.should.to.equal(_.indexOf(['lead_add', 'lead_update', 'contact_add'], key) !== -1);
      });
